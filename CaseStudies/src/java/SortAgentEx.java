...
public class SortAgentEx extends Agent {
       ...
       */
       ...
       while (iper.hasNext()) {
           ...
           if (l != null)
           {
               ...
               perW.add(ll);
       //    System.out.println("What is this "+ll.hashCode()+" ** "+l + "\n\n" + perW.toString()+"\n\n");
           }
       }
       ...
       while (perceptsInBB.hasNext()) {
         ...
         //  System.out.println("LLLLLLLLLLLLLLLLLLLLiteral is "+l);
           //Term MuAnnot = Literal.parseLiteral("fuzzy"); 
           Literal anmu = l.getAnnot("mu");
        //   System.out.println("Annottttttt :"+anmu);
           boolean hasMu = false;
           if(anmu!=null)
        	   hasMu = true;
           
           
           //boolean hasMu = l.hasAnnot();
           
           
          // System.out.println("Annottttttt :"+hasMu);
           boolean hasPerc = perW.contains(new StructureWrapperForLiteral(l));
          // System.out.println("hasPercccccccccccc :"+hasPerc);
 ...
 //
    ...
    //    	System.out.println("OOOOOOOOOOOPTIONS ALL SIZE="+options.size()+" OPS "+options.get(i).toString());
	  ...
	  //          System.out.println(" LLLLLLLLLL LOGICAL CONTEXT LLLLLLLLLLL " +  z + " " + context.toString());
		...
		//		System.out.println("PPPPPPPPPPPPP PLAN TRIGGERING DEGREE "+planTriggeringDegree);
